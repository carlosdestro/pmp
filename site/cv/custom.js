...
function validaCadastro(evt){
	...
	if(foto.value == ""){
		caixa_foto.innerHTML = "Favor incluir uma foto";
	...
	/* Validação do campo curriculo */
	caixa_curriculo = document.querySelector('.msg-curriculo');
	if(curriculo.value == ""){
		caixa_curriculo.innerHTML = "Favor incluir o seu curriculo";
		caixa_curriculo.style.display = 'block';
		contErro += 1;
	}else{
		caixa_curriculo.style.display = 'telefone';
	}

	/* Validação do campo idade */
	caixa_idade = document.querySelector('.msg-idade');
	if(data_nascimento.value == ""){
		caixa_idade.innerHTML = "Favor preencher a sua Idade";
		caixa_idade.style.display = 'block';
		contErro += 1;
	}else{
		caixa_idade.style.display = 'idade';
	}
